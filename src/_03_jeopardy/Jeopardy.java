...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		quizPanel.add(createHeader("panel"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (buttonPressed == firstButton) {
			...
			askQuestion("Is water wet, Yes or no?", "Yes", 200);
			firstButton.setText("");
		...
		// If the buttonPressed was the secondButton
			...
			askQuestion("Which football team won the first ever superbowl", "Green Bay Packers", 400);
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		if (answer.equalsIgnoreCase(correctAnswer)) {
			...
			score = score - prizeMoney;
			JOptionPane.showMessageDialog(null, "You were wrong sucka!");
